...
const GenreMovies = () => {
  const { moviesByGenre } = useOutletContext()

  return (
    <div className="max-w-7xl grid grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 place-items-center mt-20 pb-10 gap-4 mx-auto text-white">
